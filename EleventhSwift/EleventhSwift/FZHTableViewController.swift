...
//  EleventhSwift
//
//  Created by 冯志浩 on 16/7/4.
//  Copyright © 2016年 FZH. All rights reserved.
//

import UIKit

class FZHTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.registerClass(FZHTableViewCell.self, forCellReuseIdentifier: "FZHTableViewCell")
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("FZHTableViewCell", forIndexPath: indexPath)
